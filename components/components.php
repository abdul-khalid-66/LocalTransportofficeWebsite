...
<div class="container">
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
        <div class="col mb-3">
            <p class="text-body-secondary"><img src="'. $this->footerBaseUrl .'assates/images/Logo_1.png" alt=""
                    style="width: 80%; height: 40%;"></p>
        </div>
        <div class="col mb-3">
        </div>
        <div class="col mb-3">
...
<nav class="navbar navbar-expand-lg bg-body-tertiary px-5 ">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="'. $this->navbarBaseUrl .'assates/images/Logo_1.png" alt=""
